...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/AlgoDine.in",
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/AlgoDine",
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@AlgoDine",
  ...
  {
    label: "Medium",
    href: "https://AlgoDine.medium.com/",
...
const contactInfo = [
  ...
  { icon: Mail, label: "Email Us", value: "hello@AlgoDine.in", href: "mailto:hello@AlgoDine.in" },
