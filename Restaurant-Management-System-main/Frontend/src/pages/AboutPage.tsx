    ...
    <main className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-secondary via-secondary/95 to-secondary/80">
        ...
        <div className="container relative z-10 text-center max-w-4xl">
          ...
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-secondary-foreground mb-6 animate-fade-in-up">
            About <span className="gradient-text">AlgoDine Restaurant</span>
          </h1>
          <p className="font-body text-secondary-foreground/70 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto animate-fade-in-up stagger-1">
            Founded in 2020, AlgoDine Restaurant is a celebration of culinary art — blending time-honored Indian traditions with modern innovation. Every dish is crafted from locally sourced, seasonal ingredients by our team of passionate chefs.
          </p>
      ...
      <div className="container max-w-6xl py-16">
          ...
          <div className="relative animate-slide-in-left">
            ...
            <div className="bg-card border border-border rounded-3xl p-8 hover-lift relative overflow-hidden">
              ...
              <div className="space-y-4 font-body text-muted-foreground leading-relaxed">
                <p>
                  AlgoDine Restaurant was born from a simple dream: to bring authentic Indian flavors to food lovers while honoring the rich culinary heritage of India. What started as a small family kitchen in Mumbai has grown into a beloved restaurant.
                </p>
                <p>
        ...
        <div className="mt-16 bg-card border border-border rounded-3xl p-8 md:p-10 text-center animate-fade-in-up relative overflow-hidden">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-3 relative">Experience AlgoDine Restaurant</h2>
